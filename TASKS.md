...
## Phase 0 — Foundation
- [ ] **T0.1** Rebalance RFC-0012 to `Result`+ownership primary, supervisor as panic safety-net · docs · RFC-0012
- [ ] **T0.2** Domain types in `lode-core` (LogEvent/LogStream/Template/Insight + canonical newtypes `source_offset`/`index_time`/`row_anchor`, Severity) · RFC-0000/0017 · gate: core-no-deps
- [ ] **T0.3** Golden corpus harness + fixtures (labeled standard formats, PA metric, determinism test) · RFC-0003/0005
